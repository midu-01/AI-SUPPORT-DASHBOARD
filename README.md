...
👉 **[Watch the full walkthrough](https://drive.google.com/file/d/1CfCyAtKVpsxJsecN_EZzsBw5g2ts7mGJ/view?usp=sharing)** — registration, org
...
| Tests | pytest + pytest-asyncio + httpx; Playwright | 69 backend integration tests and 19 browser E2E tests |
...
The frontend has 19 Playwright E2E tests. Start the backend and frontend first, then run:
...
real PDF/DOCX/TXT upload persistence, document deletion, and logout.
